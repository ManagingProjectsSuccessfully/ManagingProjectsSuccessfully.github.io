...
|<br>**"Board" Oberfläche**<br><br>![Planoberfläche](Microsoft_Planner_PM_Tool/MS_Planner_03.png) <br>*Abbildung 3 - Planoberfläche in "Board" Übersicht* |•	Zugriff durch Auswahl eines Plans <br><br>•	Darstellung der Aufgaben in drei verschiedenen Übersichten<br><br>•	"Board" Übersicht als digitales [KANBAN-Board](Kanban_Boards.md) mit [KANBAN-Karten](Kanban_Karten.md)[^5] <br><br>•	"Board" Übersicht stellt Aufgaben in Form von Kärtchen in Spalten ("Buckets") dar<br><br> •	"Buckets"	beliebig benennbar und Anzahl unbeschränkt<br><br>•	Aufgaben nach selbstbestimmten Faktoren gruppierbar (hier: Gruppierung nach Bearbeitungsstand)<br><br>|
