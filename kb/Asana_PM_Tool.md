...
Damit alle Teammitglieder eines Projektes immer auf dem aktuellen Stand sind, gibt es die Inbox, in der sich alle Benachrichtigungen befinden. Beispiele für mögliche Benachrichtungen sind unter anderem das Hinzufügen einer neuen Aufgabe, eines neuen Projektes oder eines neuen Dokumentes zu einer bereits bestehenden Aufgabe. Auch bekommt ein Teammitglied eine Benachrichtigung in seiner Inbox, wenn es von anderen Teammitgliedern unter einer Aufgabe getagged wird. Damit Asana nicht immer geöffnet werden muss um auf dem aktuellen Stand zu sein, wird einem die Option angeboten, jede Benachrichtigung in der Inbox automatisch als E-Mail zu versenden[^2] [^5]. Darüber hinaus gibt es in der Inbox die Möglichkeit Nachrichten an andere Teammitgliederu zu senden, um sich auszutauschen oder Diskussionen zu führen[^7].
