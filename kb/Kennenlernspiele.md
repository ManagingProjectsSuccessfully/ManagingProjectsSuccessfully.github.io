...
*Phasenmodell nach Tuckman*[^7]

[Projektleiter](Projektleiter.md) können, mit Blick auf den Gruppenzusammenhalt und damit den Projekterfolg, u.a. folgende Maßnahmen koordinativ ergreifen[^5][^8]: 
...
Einige davon erfordern das Zusammenkommen vor Ort, während andere auch im Homeoffice durchführbar sind[^2].

|               |  Vor Ort                         |  Homeoffice                     |
| ------------- | -------------------------------- | ---------------------------------|
|Oberflächlich  |- [Fadennetz](#Fadennetz)         |- [Alle, die...](#Alle,_die_...)  |
|               |- Speed Meeting[^9]               |- Touch_blue[^15]                 | 
|               |- Zip-Zap[^10]                     |- Two kinds[^16]                  |
|               |- Sales Pitch[^11]                 |- Hashtags nutzen[^14]            |
|Tiefergehend   |- [Gerüchteküche](#Gerüchteküche) |- [Schlüsselbund](#Schlüsselbund) |
|               |- Value Activity[^12]              |- Gemeinsamkeiten finden[^13]     |
|               |- Was gehört wem?[^13]            |- 10 things to do in life[^16]    | 
|               |- Namen malen[^14]                |                                  |
