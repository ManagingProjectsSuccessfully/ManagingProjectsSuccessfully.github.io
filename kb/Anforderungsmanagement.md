...
2. Versionierung:
    ...
    Die Versionierung untersützt dabei Änderungen zu dokumentieren. Da sich im Laufe eines Projektes auch Anforderungen ändern, kann man somit einen Überblick behalten und über Rückverfolgbarkeit auch genau sehen welche weiteren Anforderungen betroffen sind.[^4]
...
4. Flexible Bearbeitung
    ...
    Da oftmal einige Anforderungen im Laufe eines Projekts ihre Gültigkeit verieren oder auch neue mitaufgenommen werden, ist es wichtig diese in den Dokumenten entsprechend markieren und bearbeiten zu können.[^4]
