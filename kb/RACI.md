...
Aus dieser Matrix geht hervor, welche Team-Mitglieder wofür im [Projekt](Projekt.md) verantwortlich sind.
...
* Sie ist **einfach zu erstellen** in Excel oder PowerPoint. [^4]
...
* Die Methode ordnet zwar Beteiligten Aufgaben zu, die **genaue Ausgestaltung** der Rolle muss jedoch zusätzlich in Form einer **Rollenbeschreibung** erfolgen. [^4]
<br>
...
Es gibt eine Reihe von Varianten oder Alternativen [^3], die einen ähnlichen Matrix-Ansatz verfolgen, aber andere Begriffe verwenden. Hier finden Sie einige dieser Varianten:
## RASCI:
