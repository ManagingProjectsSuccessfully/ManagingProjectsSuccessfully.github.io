...
|-----------------------------------------|--------------------------|------------------------------------|------------------------------------|--------------------|----------------|
| Beliebte Zertifizierung<br>als Beispiel | IPMA Level D             | PMI-ACP-Zertifizierung              | PMP-Zertifikat                     | Prince2 Foundation | PSM1           |
...
Durch eine erlangte Zertifizierung im PM werden nicht nur Einarbeitungszeiten aufgrund der bereits erworbenen fachlichen und/oder methodischen Fähigkeiten für neue Mitarbeiter verkürzt, sondern auch Karrieresprünge für bestehende Mitarbeiter ermöglicht.[^9][^10]
